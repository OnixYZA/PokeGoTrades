/**
 * Generated Pokédex data — DO NOT EDIT BY HAND.
 *
 * Regenerate with the one-off script that produced this file (see PokemonPickerModal sub-agent
 * report), which downloads PokeAPI's own CSV export and derives, per national dex id, the English
 * name and primary (slot-1) type of the pokemon row whose id equals the species id:
 ...
 *
 * National dex order, species 1 through 1025. Alternate formes (e.g. Deoxys' Attack/Defense/Speed
 * formes, regional variants with their own synthetic ids) are intentionally left out: this is the
 * base species list backing a name+type search, not a full forme-aware pokedex — see constants/pokedex.ts.
 */
export const POKEDEX_DATA: readonly (readonly [
  id: number,
  name: string,
  primaryType: string,
])[] = [
  ...
  [875, 'Eiscue', 'Ice'],
  [876, 'Indeedee', 'Psychic'],
  [877, 'Morpeko', 'Electric'],
  [878, 'Cufant', 'Steel'],
